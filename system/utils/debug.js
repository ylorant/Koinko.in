...
{
	$('<a class="debug-tab-link btn" onclick="debug.toggleTab(this, \'debug-tab-' + debug.iTab + '\');">AJAX Query ' + debug.iTab + '</a>').appendTo("div.debug-window div.debug-tabs");
...
debug.toggleTab = function(link, tab)
{
	...
	$('div.debug-window a.debug-tab-link').removeClass('btn-shorten');
	$('div.debug-window div.debug-content div#' + tab).show();
	
	$(link).addClass('btn-shorten');
}
